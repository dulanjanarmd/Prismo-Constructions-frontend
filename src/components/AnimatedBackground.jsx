...
const AnimatedBackground = () => {
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden bg-slate-50 pointer-events-none">
      ...
      {/* Blob 1 */}
      <div className="absolute -top-[10%] -left-[10%] w-[500px] h-[500px] rounded-full bg-gradient-to-r from-[#f5a623]/30 to-[#fca311]/40 mix-blend-multiply blur-[100px] animate-blob" />

      {/* Blob 2 */}
      <div className="absolute top-[20%] -right-[10%] w-[600px] h-[600px] rounded-full bg-gradient-to-r from-[#fca311]/30 to-[#ffb74d]/30 mix-blend-multiply blur-[120px] animate-blob animation-delay-2000" />

      {/* Blob 3 */}
      <div className="absolute -bottom-[20%] left-[20%] w-[700px] h-[700px] rounded-full bg-gradient-to-r from-[#f5a623]/20 to-[#fca311]/30 mix-blend-multiply blur-[150px] animate-blob animation-delay-4000" />
